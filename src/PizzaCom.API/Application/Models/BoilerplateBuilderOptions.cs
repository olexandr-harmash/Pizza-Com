...
public class BuildBoilerplateDTO : BoilerplateDetails
{
...
{
    public List<AppliedIngredientSummaryDTO> SelectedIngredients { get; set; } // List of ingredient IDs
    public List<AppliedOptionSummaryDTO> AppliedOptions { get; set; }
}
...
{
    public int PizzaTemplateId { get; set; } // Уникальный идентификатор шаблона пиццы (может быть пустым для создания нового)
